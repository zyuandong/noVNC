...
!(function (t) {
  ...
  var x = {
      init: function (t) {
        ...
        (x.supportsTouch =
          ...
          (x.isOperaMobile =
            "Opera" === n.appName && x.supportsTouch && /Presto/.test(n.userAgent)),
  ...
  Object.defineProperty(R, "__esModule", { value: !0 }),
    (R.default = function t(e, n, r) {
      if (
        ((r = r || {}),
        i.default.string(e) && -1 !== e.search(" ") && (e = z(e)),
        i.default.array(e))
      )
        return e.reduce(function (e, o) {
          return (0, j.default)(e, t(o, n, r));
        }, r);
      if ((i.default.object(e) && ((n = e), (e = "")), i.default.func(n)))
        (r[e] = r[e] || []), r[e].push(n);
  ...
  function V(t, e) {
    return (
      (e = e || {}), b.default.isOperaMobile && W(t) ? L("screen", t, e) : L("client", t, e), e
    );
  }
  function N(t) {
    var e = [];
  ...
  function ht(t, e) {
    ...
    if ("dragmove" === r.type || "dragend" === r.type) {
      ...
      var a = r,
        s = dt(n, a, o);
      (i.rejected =
        i.rejected && !!s && s.dropzone === i.cur.dropzone && s.element === i.cur.element),
  ...
  var Mt = {
    ...
    install: function (t) {
      t.usePlugin(mt.default),
        t.usePlugin(_t.default),
        t.usePlugin(c.default),
        t.usePlugin(ut.default);
    },
  };
  Tt.default = Mt;
  var jt = {};
  ...
  Object.defineProperty(Rt, "__esModule", { value: !0 }),
    ...
    (Rt.getScrollSize = function (t) {
      return (
        i.default.window(t) && (t = window.document.body), { x: t.scrollWidth, y: t.scrollHeight }
      );
    }),
  ...
  function Nt(t, e, n, r, o) {
    return e.testIgnoreAllow(e.options[t.name], n, r) && e.options[t.name].enabled && Ht(e, n, t, o)
      ? t
      : null;
  }
      ...
      (n = [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (
              ((this.result = i), !i.changed && (!o || o < this.states.length) && e.interacting())
            )
              return !1;
            if (t.modifiedCoords) {
  ...
  function He(t) {
    t.pointerIsDown &&
      (Qe(t.coords.cur, t.offset.total), (t.offset.pending.x = 0), (t.offset.pending.y = 0));
  }
  function Ke(t) {
    Ze(t.interaction);
  }
      ...
      (n = [
        {
          ...
          value: function (t) {
            var e,
              n = this.global;
            (e = this.types[t.type]) && pn(t, e),
              !t.propagationStopped && n && (e = n[t.type]) && pn(t, e);
          },
        },
        {
          key: "on",
    ...
    (gn.createInteractStatic = function (t) {
      ...
      return (
        ...
        (e.on = (0, Yt.warnOnce)(function (t, e, n) {
          if (
            (i.default.string(t) && -1 !== t.search(" ") && (t = t.trim().split(/ +/)),
            i.default.array(t))
          ) {
  ...
  cr.default = dr;
  var pr =
    "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0;
  fr.init(pr);
  var vr = {};
    ...
    set: function (t) {
      ...
      var s = e.subModification.setAll(
          Or(
            Or({}, t),
            {},
            { rect: a, edges: e.linkedEdges, pageCoords: r, prevCoords: r, prevRect: a }
          )
        ),
        l = s.delta;
      return (
        s.changed &&
          (i(e, Math.abs(l.x) > Math.abs(l.y), s.coords, s.rect), (0, j.default)(r, s.coords)),
        s.eventProps
      );
    },
  ...
  var go = {
    ...
    install: function (t) {
      ...
      t.usePlugin(xr.default),
      (e.modifiers = po.default),
      po.default)) {
        var r = po.default[n],
          o = r._defaults,
          i = r._methods;
  ...
  function Mo(t, e) {
    ...
    if ((e.fire("pointerEvents:fired", c), "tap" === a)) {
      var h = u.double
        ? Mo({ interaction: n, pointer: r, event: o, eventTarget: i, type: "doubletap" }, e)
        : u;
        ...
        return (function (t, e, n) {
          for (
            var r = i.default.string(t.target)
                ? Z.from(t._context.querySelectorAll(t.target))
                : [t.target],
              o = n.window.Promise,
              a = o ? [] : null,
              s = function () {
